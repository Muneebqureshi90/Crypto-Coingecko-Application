  ...
  "nfixed nz-50 ngap-4 nbg-background np-6 nshadow-lg ntransition nease-in-out data-[state=open]:nanimate-in data-[state=closed]:nanimate-out data-[state=closed]:nduration-300 data-[state=open]:nduration-500",
  {
    variants: {
      side: {
        ...
        right:
          "ninset-y-0 nright-0 nh-full nw-3/4 nborder-l data-[state=closed]:nslide-out-to-right data-[state=open]:nslide-in-from-right sm:nmax-w-sm",
      },
    },
    defaultVariants: {
      side: "right",
  ...
  <SheetPortal>
    ...
    <SheetPrimitive.Content ref={ref} className={cn(sheetVariants({ side }), className)} {...props}>
      ...
      <SheetPrimitive.Close
        className="nabsolute nright-4 ntop-4 nrounded-sm nopacity-70 nring-offset-background ntransition-opacity hover:nopacity-100 focus:noutline-none focus:nring-2 focus:nring-ring focus:nring-offset-2 disabled:npointer-events-none data-[state=open]:nbg-secondary">
...
const SheetHeader = ({
  ...
  <div
    className={cn("nflex nflex-col nspace-y-2 ntext-center sm:ntext-left", className)}
    {...props} />
)
