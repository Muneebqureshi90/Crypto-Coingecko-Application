...
export const sendVerificationOtp = createAsyncThunk('user/sendVerificationOtp', async ({
                                                                                           jwt,
                                                                                           verificationType
                                                                                       }, {rejectWithValue}) => {
    try {
...
export const enableTwoFactorAuth = createAsyncThunk('user/enableTwoFactorAuth', async ({
                                                                                           otp,
                                                                                           jwt
                                                                                       }, {rejectWithValue}) => {
    try {
...
// Update Password
export const updatePassword = createAsyncThunk('user/updatePassword', async ({
                                                                                 userId,
                                                                                 newPassword
                                                                             }, {rejectWithValue}) => {
    try {
...
export const getUserDetailsById = createAsyncThunk('user/getUserDetailsById', async ({
                                                                                         userId,
                                                                                         jwt
                                                                                     }, {rejectWithValue}) => {
    try {
